        ...
        <CardContent className="space-y-6 p-8">
          ...
          <div className="space-y-4">
            <h1 className="font-heading text-5xl uppercase leading-none tracking-[0.12em] text-white">
              Intra. Rezerva. Scaneaza.
            </h1>
            <p className="text-base leading-8 text-white/72">
              Contul tau este baza pentru rezervare, cabinet personal, PDF,
              partajare si istoricul de acces la stadion.
            </p>
          </div>
          <div className="grid gap-3 text-sm text-white/72">
            <div className="rounded-3xl border border-white/10 bg-white/5 p-4">
              Limita implicita: 4 bilete / meci pentru suporteri
            </div>
            <div className="rounded-3xl border border-white/10 bg-white/5 p-4">
